        ...
        return (
            <div className='col-xs-12 full-height'>
                <Panel title={ t('How To Play on Manacrest Online') }>
                    ...
                    <p><Trans i18nKey='howtoplay.thisguide'>This guide is aimed at players familiar with Manacrest who want to start playing online using the Manacrest Online platform.</Trans></p>
                    ...
                    <p><Trans i18nKey='howtoplay.addingdecks'>Players are able to build decks using any of the available cards under the "Build deck" page. After building a deck, name/save it. You are now ready to start playing. Head over to the <Link href='/play'>Play</Link> section to create, join or watch games.</Trans></p>
                    ...
                    <p><Trans i18nKey='howtoplay.bugs'>Manacrest Online is currently in beta and still a work in progress. If you happen upon a card that you believe is not working as it should, it would help immensely if you would submit an issue on <a target='_blank' href='https://reddit.com/r/manacrest' rel='noopener noreferrer'>the Manacrest subreddit</a>. Other comments and/or feedback can be left on GitHub as well.</Trans></p>
